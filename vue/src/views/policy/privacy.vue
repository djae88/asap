    ...
    >
        ...
        >
            ...
            <div class="rule_box pt-10 pa-16">
                ...
                <p>ASAP(이하 "회사"라 함)은 이용자의 개인정보보호를 매우 중요시하며, 이용자가 회사의 ‘ASAP’ 및 관련 서비스(이하 "서비스"라 함)를 이용함과 동시에 온라인상에서 회사에 제공한 개인정보가 보호 받을 수 있도록 최선을 다하고 있습니다. 이에 회사는 정보통신서비스제공자가 준수하여야 하는 대한민국의 관계 법령 및 개인정보보호, 정보보호에 관한 규정을 준수하고 있습니다. 회사는 개인정보처리방침을 통하여 이용자들이 제공하는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다 </p>
                ...
                <h3>14. 부칙</h3>
                <p>이 개인정보처리방침은 2023년 5월 1일부터 적용되며, 본 개인정보처리방침의 내용 추가, 삭제 및 수정이 있을 경우 개정 최소 7일전에 회사 서비스 내의 공지사항을 통하여 고지할 것 입니다. 다만, 수집하는 개인정보의 항목, 이용목적의 변경 등과 같이 이용자 권리의 중대한 변경이 발생할 때에는 최소 30일 전에 공지하며, 이 때 변경 내용에 대해 동의하지 않는 회원에 대해 회원 탈퇴를 할 수 있는 안내를 포함합니다.</p>
                <p>- 개인정보처리방침 공고일자 : 2023년 5월 1일</p>
                <p>- 개인정보처리방침 시행일자 : 2023년 5월 1일</p>
            </div>
        </v-sheet>
    </v-sheet>
</template>
